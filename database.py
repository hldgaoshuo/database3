...
class Database:
    ...
    def __init__(self, pager: Pager, free_list: FreeList, table_seq_gen: TableSeqGenerator, table_list: TableList, tables: dict[str, Table]):
    ...
    def create(self, name: str, col_names: list[str], col_types: list[int]):
        ...
        table = new_table(self.pager, self.free_list, name, seq, col_names, col_types)
...
def new_database(pager: Pager) -> Database:
    ...
    db = Database(pager, free_list, table_seq_gen, table_list, tables)
    return db
